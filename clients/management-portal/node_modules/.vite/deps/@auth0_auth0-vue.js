...
var h = { name: "auth0-spa-js", version: "2.1.2" };
var p = () => Date.now();
...
var k = class _k extends m {
  constructor(e, t) {
    super("missing_refresh_token", `Missing Refresh Token (audience: '${v(e, ["default"])}', scope: '${v(t)}')`), this.audience = e, this.scope = t, Object.setPrototypeOf(this, _k.prototype);
  }
};
function v(e, t = []) {
...
var z = class _z {
  ...
  static fromKey(e) {
    ...
    return new _z({ clientId: i, scope: n2, audience: o }, t);
  }
  static fromCacheEntry(e) {
    const { scope: t, audience: i, client_id: o } = e;
    return new _z({ scope: t, audience: i, clientId: o });
  }
};
var x = class {
  set(e, t) {
